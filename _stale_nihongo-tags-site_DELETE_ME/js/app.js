...
export const CHAPTERS = [
  { n: 1, days: [1], title: 'Core only', ja: '核だけで話す', sub: 'One word is a sentence. Greetings, time words, bare nouns.', particles: [] },
  ...
  { n: 7, days: [8, 9], title: 'Move the chunks', ja: '荷物を動かす', sub: 'Same sentence, new order, new emphasis. All ten tags.', particles: [] },
  { n: 8, days: [10], title: 'Drop the chunks', ja: '荷物を省く', sub: 'Answer with only what is new. Context does the rest.', particles: [] },
  { n: 9, days: [11, 12], title: 'Decorate the chunks', ja: '荷物を飾る', sub: 'Adjectives, の-links, numbers and colours inside a chunk.', particles: [] },
  { n: 10, days: [13, 14], title: 'Talk in scenes', ja: '場面で話す', sub: 'Twelve real-life scenes, start to finish. Final test.', particles: [] }
];
...
// ---------- rendering ----------
export function pColor(p) { return p ? `var(--p-${p})` : 'var(--p-none)'; }
...
export function renderHeader(active) {
  ...
  const links = [['', 'Home'], ['grammar/', 'Grammar'], ['drill/', 'Drill'], ['scenes/', 'Scenes'], ['progress/', 'Progress']];
